...
\begin{table}[H]
    ...
    \begin{tabular}{|C{0.1\textwidth}|C{0.4\textwidth}|C{0.5\textwidth}|}
         ...
         2 & Crear secuencias & Ejecutar el \textit{script} Sequencias.sql \\ \hline
         3 & Crear procedimientos & Ejecutar el \textit{script} Procedimientos.sql \\ \hline
         4 & Insertar datos & Ejecutar el \textit{script} INSERTAR\_DATOS \\\hline
    \end{tabular}
